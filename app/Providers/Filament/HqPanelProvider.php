...
class HqPanelProvider extends PanelProvider
{
        ...
        return $panel
            ...
            ->userMenuItems([
                'profile' => MenuItem::make()
                    ...
                    ->url(fn(): string => \App\Filament\Hq\Pages\MyProfile::getUrl()),
            ])
            ...
            ->renderHook(
                ...
                fn(): string => new HtmlString("
                    <style>
                        ...
                        #HqHelpModal { display: none; position: fixed; z-index: 10000; left: 0; top: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.6); }
                        .help-box { background: #fff; margin: 4% auto; padding: 30px; border-radius: 12px; width: 65%; max-height: 85vh; overflow-y: auto; color: #333; box-shadow: 0 10px 25px rgba(0,0,0,0.5); position: relative; }
            ...
            ->renderHook(
                ...
                function (): string {
                    ...
                    return new HtmlString("
                        ...
                        <div id='HqHelpModal'>
                            <div class='help-box'>
                                <div class='help-header'>HQ Administration Support</div>
                                <div class='help-tabs'>
                                ...
                                <li><strong>Review:</strong> Evaluate centre-level nominations for eligibility.</li>

                                <li><strong>Finalize:</strong> Add HQ Remarks and click 'Approve' or 'Reject'.</li>

                                <li><strong>Export:</strong> Download filtered lists as Excel for offline records.</li>
                                ...
                                <h3>Trainings & Calendar Management</h3>

                                <ul>

                                <li><strong>Master List:</strong> Create training modules and set seat quotas per centre.</li>

                                <li><strong>Scheduling:</strong> Use the Calendar to visualize timelines and avoid program overlaps.</li>
                                ...
                                <li>Register and manage accounts for centre-level nomination officers.</li>

                                <li>Enable or disable coordinator access based on current postings.</li>
                                ...
                                <li>Generate detailed analytics across all ISRO centres.</li>

                                <li>Filter by year or designation to export high-level summary reports.</li>
                ...
                fn(): string => new HtmlString("
                    <script>
                        function openHelpModal() {
                            document.getElementById('HqHelpModal').style.display = 'block';
                            document.body.style.overflow = 'hidden';
                        }
                        function closeHelpModal() {
                            document.getElementById('HqHelpModal').style.display = 'none';
                            document.body.style.overflow = 'auto';
                        }
                        window.onclick = function(event) {
                            let modal = document.getElementById('HqHelpModal');
                    ...
                    <footer style='background-color: #003249; color: white; padding: 25px 20px; text-align: center; font-size: 13px; width: 100%;'>
                        <div style='margin-bottom: 12px;'><img src='" . asset('images/logo.png') . "' style='height: 40px; margin: 0 auto;'></div>
    ...
    private function getFaqsForHelp(): string
    {
        if (!class_exists('App\Models\Faq')) {
            return "<p style='padding:20px; text-align:center;'>FAQ data not available.</p>";
        }
        ...
        if ($faqs->isEmpty()) {
            return "<p style='padding:20px; text-align:center;'>No FAQs available at this time.</p>";
        }
