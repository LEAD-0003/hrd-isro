...
class FeedbackReport extends Page
{
    ...
    // Must be nullable to prevent Livewire crashes when selects are cleared to ""
    ...
    {
        // Whenever a filter changes, safely reset drill-down and compare views
    ...
    #[Computed] // Added missing Computed attribute here so it works in the view dropdown
